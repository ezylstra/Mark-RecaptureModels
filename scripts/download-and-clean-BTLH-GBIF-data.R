...
elevation_comparison <- read.csv('data/elevation-models-comparison.csv')

# I just looked at the data frame and the difference of the resulting elevations
# between models is minimal. I still need to read about each model and maybe do
# a better comparison running some code.
